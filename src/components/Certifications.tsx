...
const Certifications = () => {
  ...
  const certificates: Certificate[] = [
    {
      ...
      issuer: 'Meta',
      date: '2023',
      driveId: '1Mg8Z5urqYI_D_TXgc72O2dySfnD4HssT', // Replace with actual file ID
      type: 'Frontend',
      skills: ['React', 'JavaScript', 'JSX'],
      description: 'Advanced React development certification covering hooks, state management, and modern patterns.'
    },
    {
      id: '2',
      ...
      description: 'Comprehensive Node.js certification covering server-side development and API design.'
    },
    {
      id: '3',
  ...
  return (
    <section id="certifications" className="py-20 md:py-24 lg:py-32 relative overflow-hidden floating-orbs">
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <Badge 
                      variant="secondary" 
                      className={`mb-3 ${typeColors[certificate.type] || 'bg-muted'}`}
                    >
                      {certificate.type}
                    </Badge>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    {certificate.skills.length > 3 && (
                      <span className="text-xs text-muted-foreground">
                        +{certificate.skills.length - 3} {t('certifications.more')}
                      </span>
                    )}
                  </div>
                )}
                ...
                <div className="flex gap-2 mt-4">
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.open(getGoogleDriveViewUrl(certificate.driveId), '_blank');
                    }}
                  >
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.open(getGoogleDriveDownloadUrl(certificate.driveId), '_blank');
                    }}
                  >
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] p-0">
            ...
            <div className="px-6 pb-6">
              ...
              <div className="relative bg-muted rounded-lg overflow-hidden" style={{ height: '500px' }}>
                <iframe
                  src={getGoogleDrivePreviewUrl(selectedCertificate?.driveId || '')}
              ...
              <div className="flex gap-4 mt-6">
                <Button
                  onClick={() => window.open(getGoogleDriveViewUrl(selectedCertificate?.driveId || ''), '_blank')}
                  className="flex-1"
                >
                  <ExternalLink className="h-4 w-4 mr-2" />
                ...
                <Button
                  variant="outline"
                  onClick={() => window.open(getGoogleDriveDownloadUrl(selectedCertificate?.driveId || ''), '_blank')}
                >
